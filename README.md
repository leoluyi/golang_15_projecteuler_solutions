...
[n = 20; (2 * n)! / (n!)^2 - Wolfram|AlphaUh oh! Wolfram|Alpha doesn't run without JavaScript. Please enable JavaScript. If you don't know how, you can find…www.wolframalpha.com](https://www.wolframalpha.com/input/?i=n+%3D+20%3B+(2+*+n)!+%2F+(n!)^2)
